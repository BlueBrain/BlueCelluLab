...
"""
BGLibPy documentation build configuration file, created by
...
version = bglibpy.__version__
# The full version, including alpha/beta/rc tags.
release = bglibpy.__version__
...
latex_documents = [
  ('index', 'BGLibPy.tex', u'BGLibPy Documentation',
   u'BBP', 'manual'),
]
...
man_pages = [
    ('index', 'bglibpy', u'BGLibPy Documentation',
     [u'BBP'], 1)
]
...
texinfo_documents = [
  ('index', 'BGLibPy', u'BGLibPy Documentation',
   u'BBP', 'BGLibPy', 'One line description of project.',
   'Miscellaneous'),
]
