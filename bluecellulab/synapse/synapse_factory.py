...
class SynapseFactory:
    ...
    def create_synapse(
        ...
        if syn_type == SynapseType.GABAAB:
            ...
            synapse = GabaabSynapse(cell.rng_settings, cell.cell_id.id, syn_hoc_args, syn_id, syn_description,
                                    popids, extracellular_calcium, randomize_gaba_risetime)
        elif syn_type == SynapseType.AMPANMDA:
            synapse = AmpanmdaSynapse(cell.rng_settings, cell.cell_id.id, syn_hoc_args, syn_id, syn_description,
                                      popids, extracellular_calcium)
        else:
            synapse = GluSynapse(cell.rng_settings, cell.cell_id.id, syn_hoc_args, syn_id, syn_description,
                                 popids, extracellular_calcium)
