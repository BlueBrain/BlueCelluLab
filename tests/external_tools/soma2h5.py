...
d = [h5.create_dataset('a%d' % gid, (num_frames,), "<f4", chunks=(frame_chunk,),
     compression='gzip',
     compression_opts=5,
     track_times=None) for gid in gids]
...
for chunk_count, frame_begin in enumerate(range(0, num_frames, frame_chunk)):
