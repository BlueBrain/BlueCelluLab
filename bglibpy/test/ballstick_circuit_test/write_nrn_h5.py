...
a1 = numpy.array([[2.0, 1.0, 1.0, 0.0, 100.0, # pre_gid, delay, postsec, post seg id, distance along seg 
                   ...
                   1.0, 0.5, 650.0, 10, 10.0, 0, # gsyn, u, d, f, dtc, synapse type (>=100 exc, <100 inh),  
                   2.0, 1.0, 1.0, # mtype (index in circuit.mvd2 mtype list), BO dend (not used), BO axon (not used)
...
a2 = numpy.array([[1.0, 1.0, 1.0, 0.0, 150.0, # pre_gid, delay, postsec, post seg id, distance along seg 
                   0.0, 0.0, 0.0, # presec, preseg, preseg distance
                   1.0, 0.5, 650.0, 10, 2.0, 100, # gsyn, u, d, f, dtc, synapse type (>=100 exc, <100 inh),  
                   1.0, 1.0, 1.0, # mtype (index in circuit.mvd2 mtype list), BO dend (not used), BO axon (not used)
                   1.0, 2.0]], dtype=">f4") # ASE (not used), branch type on post
